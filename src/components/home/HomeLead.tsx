    ...
    <div className="px-5 pb-10 pt-10 md:px-11 md:pb-16 md:pt-16">
      ...
      <p className="mt-[14px] text-[15px] text-muted">
        ...
        <GlideGame
          locale={locale}
          iconOnly
          triggerClassName="-my-2 -ml-1.5 rounded p-2 align-middle outline-none transition-opacity hover:opacity-70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        />
      </p>
