...
export type Project = {
  ...
  >;
  relation?: "personal" | "freelance" | "employee";
  featured?: boolean;
  tooling?: {
    en?: string;
    nl?: string;
...
export type CASE_STUDY_QUERY_RESULT = {
  ...
  state: "cancelled" | "done" | "live" | "paused" | null;
  engagement: "freelance" | "full-time" | "internship" | "owner" | null;
  relation: "employee" | "freelance" | "personal" | null;
  role: string | null;
  client: string | null;
  deck: {
    en?: string;
...
// Query: *[_id == "profile"][0]{    name,    tagline,    roleLine,    filterIntro,    leadHeadline,    leadSubline,    aboutHeadline,    bio,    "portraitUrl": portrait.asset->url,    beyondCode[]{      title,      body    },    location,    email,    socialLinks,    "cvEnUrl": cvEn.asset->url,    "cvNlUrl": cvNl.asset->url,    vatNumber,    copyrightYear  }
