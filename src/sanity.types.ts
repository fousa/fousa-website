...
// Query: *[_type == "project"] | order(featured desc, year desc, name asc) {    _id,    name,    "slug": slug.current,    year,    endYear,    state,    engagement,    featured,    role,    client,    deck,    summary,    liveUrl,    githubUrl,    writeupUrl,    "employer": employer->{      _id,      "name": organisation,      "slug": lower(organisation)    },    "stack": stack[]->{      _id,      name,      "slug": slug.current    },    tooling,    featureTooling,    "hasBody": count(body.en) > 0,    "galleryCount": count(gallery)  }
