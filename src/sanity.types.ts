...
// Query: *[_type == "project"] | order(featured desc, year desc, name asc) {    _id,    name,    "slug": slug.current,    year,    endYear,    state,    engagement,    featured,    role,    client,    deck,    summary,    description,    outcome,    liveUrl,    githubUrl,    writeupUrl,    "employer": employer->{      _id,      name,      "slug": lower(organisation)    },    "stack": stack[]->{      _id,      name,      "slug": slug.current    },    "screenshots": screenshots[]{      _key,      alt,      "asset": asset->    },    tooling,    featureTooling,    "hasBody": count(body.en) > 0,    "galleryCount": count(gallery)  }
